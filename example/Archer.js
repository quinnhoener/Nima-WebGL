var Archer = (function ()
{
	...
	function Archer(canvas)
	{
		...
		this._Graphics.setSize(256, 256);

		this._LastAdvanceTime = Date.now();
		this._ViewTransform = _mat2d.create();
		this._ViewTransform[0] = .2;
		this._ViewTransform[3] = .2;
		// this._ViewTransform[4] = 0;
		// this._ViewTransform[5] = 0;
	...
	function _Advance(_This)
	{
		...
		{
			actor.setXY(0, 0);
			// actor.setXY(actor._X() + 1, actor._Y() + 1);
			...
			_This._IdleAnimation.advance(elapsed);
			_This._IdleAnimation.apply(actor, 1);
